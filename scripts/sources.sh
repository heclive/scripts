...
REP2="deb http://ag-projects.com/debian stable main" #deb ftp.de.debian.org/debian-archive/debian hamm main "
REP3="deb-src http://ag-projects.com/debian stable main" #deb http://http.kali.org/kali kali main non-free contrib"
